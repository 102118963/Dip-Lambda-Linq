...
namespace FileParserNetStandard_Tests {
    ...
    public class Tests {
        ...
        private string _csvPath = "F:/YEAR 2/Dip-Seminar-Delegates-Lambda-Linq_Exercises/Files/Files/data.csv";  // change to appropriate path
        private string _tsvPath = "F:/YEAR 2/Dip-Seminar-Delegates-Lambda-Linq_Exercises/Files/Files/data.tsv";  // change to appropriate path

        private string _writeFile = "F:/YEAR 2/Dip-Seminar-Delegates-Lambda-Linq_Exercises/Files/Files/dataWrite.txt";  // change to appropriate path
